...
class Gallery
{
   ...
   */
  public function __construct( $increments = 15, $filePath = 'img/Galeria/', $publicPrefix = null )
  {
    ...
    $this->files =  glob( $filePath . '*.[pP][nN][gG]' );
  ...
  public function display()
  {
    ...
    if (count($this->filesArray)){
      foreach ( $this->filesArray as $file ) {
        ...
        $imgPath = $this->publicPrefix . $this->filePath . $filename;
