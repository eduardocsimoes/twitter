...
define('USER', 'root');
define('PASS', '');
define('DBSA', 'allanfotografia');

// DEFINE SERVIDOR DE E-MAIL ################
define('MAILUSER', 'eduardocsimoes81@gmail.com');
define('MAILPASS', 'senhadoemail');
define('MAILPORT', 'postadeenvio');
define('MAILHOST', 'servidordeenvio');

// DEFINE IDENTIDADE DO SITE ################
define('SITENAME', 'Allan Fotografia');
...
define('HOME', 'http://localhost:8080/Fotografia');
define('THEME', 'AllanFotografia');
